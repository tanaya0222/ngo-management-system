...
CREATE TABLE `fund_raising` (
  ...
  CONSTRAINT `fund_raising_ibfk_1` FOREIGN KEY (`Event_id`) REFERENCES `event` (`Event_id`)
...
INSERT INTO `fund_raising` VALUES ('E001','2023-09-15','Koregaon Park'),('E002','2023-10-20','Kothrud'),('E003','2023-11-10','Baner'),('E004','2023-12-05','Wakad');
